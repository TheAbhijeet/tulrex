...
export default function Header() {
    ...
    return (
        <header className="sticky md:px-2 top-0 z-40 w-full bg-slate-900/70 backdrop-blur-sm border-b border-slate-800">
                ...
                <div className="md:hidden absolute top-16 left-0 w-full bg-slate-900 border-b border-slate-800 shadow-lg">
                    <div className="container mx-auto px-4 py-4 space-y-4">
                        ...
                        <Link
                            ...
                            className="flex items-center gap-3 px-3 py-2 text-base font-medium text-slate-300 hover:text-white hover:bg-slate-800 rounded-md transition-colors"
                        >
                            <Info size={20} />
                            About
                        </Link>
